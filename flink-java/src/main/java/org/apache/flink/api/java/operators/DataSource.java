...
public class DataSource<OUT> extends Operator<OUT, DataSource<OUT>> {
	 ...
	 * @return This data source with annotated split data properties.
	 */
	public DataSource<OUT> setSplitDataProperties(SplitDataProperties<OUT> splitDataProperties) {
		this.splitDataProperties = splitDataProperties;
